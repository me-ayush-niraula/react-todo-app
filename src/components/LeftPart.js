  ...
  return (
    <div className="leftPart container-fluid">
      ...
      <p className="describeText">
        This is simple React Todo created as a side project, just to get my hands into basics of react including components and props along with some hooks such as useState and useEffect. <br />
        Created by:{" "}
